...
def render_todos():
    ...
    for i in range(0, len(rows)):
        ...
        l.grid(row=i, column=0, sticky='w')#cual es la fila que quiero reactualizar
...
frame.grid(row=1, column=0, columnspan=3, padx=5, sticky='nswe')
e.focus() #escritura directa!
